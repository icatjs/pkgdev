        ...
        start: function(count) {
            ...
            if (!config.current) {
                ...
                if (config.current.semaphore < 0) {
                    ...
                    QUnit.pushFailure("Called start() while already started (test's semaphore was 0 already)",
        ...
        DiffMatchPatch.prototype.diffCleanupSemantic = function(diffs) {
            ...
            while (pointer < diffs.length) {
                if (diffs[pointer][0] === DIFF_EQUAL) { // Equality found.
                    ...
                    // sides of it.
                    if (lastequality && (lastequality.length <= Math.max(lengthInsertions1, lengthDeletions1)) && (lastequality.length <= Math.max(lengthInsertions2,
                    lengthDeletions2))) {
...
(function() {
    ...
    QUnit.done(function(details) {
        ...
        banner = id("qunit-banner"),
            ...
            details.runtime, " milliseconds.<br />", "<span class='passed'>",
            details.passed, "</span> assertions of <span class='total'>",
            details.total, "</span> passed, <span class='failed'>",
            details.failed, "</span> failed."].join("");
    ...
    QUnit.log(function(details) {
        ...
        if (!details.result && hasOwn.call(details, "expected")) {
            ...
            if (actual !== expected) {
                ...
                message += "<tr class='test-message'><th>Message: </th><td>" + "Diff suppressed as the depth of object is more than current max depth (" + QUnit.config.maxDepth + ").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to " + " run with a higher max depth or <a href='" + setUrl({
                    maxDepth: -1
